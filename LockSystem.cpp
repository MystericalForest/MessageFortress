...
LockSystem::LockSystem(int c1, int c2, int l1, int l2, int redPin, int greenPin, int connPin, int btn1, int btn2, int btn3, int clk, int dio)
    : codeLED1(c1), codeLED2(c2), lockLED1(l1), lockLED2(l2),
      status(redPin, greenPin, connPin),
      display(btn1, btn2, btn3, clk, dio),
